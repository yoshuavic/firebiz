...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { email: @register.email, first_name: @register.first_name, gender: @register.gender, last_name: @register.last_name, phone: @register.phone, shirt: @register.shirt } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { email: @register.email, first_name: @register.first_name, gender: @register.gender, last_name: @register.last_name, phone: @register.phone, shirt: @register.shirt } }
